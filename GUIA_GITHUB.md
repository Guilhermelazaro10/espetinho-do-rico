...
```text
Espetinho do Rico PDV 1.0.3
```

6. Anexe um destes arquivos:

```text
$env:USERPROFILE\Desktop\PVD\dist-desktop\Espetinho do Rico PDV Setup 1.0.3.exe
```

ou

```text
$env:USERPROFILE\Desktop\PVD\dist-desktop\Espetinho do Rico PDV 1.0.3.exe
```
